...
tree = ttk.Treeview(root, columns=('Name', 'Count', 'ID', 'Last Active Time', 'Connection URL'), show='headings')
...
for workspace in final_workspaces:
    ...
    tree.insert('', 'end', values=(name, count, id_val, last_active_time, connection_url),
